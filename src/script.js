...
let phrases = [{
    ...
    {
        text: 'устроить день космического исследователя, изучая факты о космосе и играя в космические видеоигры - отправиться в захватывающее путешествие сквозь бесконечные просторы Вселенной!',
